    ...
    return (
      <section className="stack host-page">
        <div className="card">
          ...
          <p className="muted">First host is owner. Enter <code>BOOTSTRAP_TOKEN</code>.</p>
  ...
  return (
    <section className="stack host-page">
      <div className="card">
        ...
        <p className="muted">Voucher PDF per item. After close: one invoice per winning guest.</p>
